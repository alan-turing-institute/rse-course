...
# **_Exercise_: Fill in the gaps for testing**
...
get_ipython().run_cell_magic('bash', '', 'rm -rf DiffusionExercise\nmkdir DiffusionExercise\n')
...
get_ipython().run_cell_magic('bash', '', 'rm -rf DiffusionSolution\nmkdir DiffusionSolution\n')
