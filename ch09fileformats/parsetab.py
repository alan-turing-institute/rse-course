...
_lr_productions = [
  ...
  ('system -> equation','system',1,'p_expression_system','parsereactions.py',11),
  ('system -> system TEXNEWLINE NEWLINE equation','system',4,'p_expression_combine_system','parsereactions.py',16),
  ('equation -> side ARROW side','equation',3,'p_equation','parsereactions.py',21),
  ('side -> molecules','side',1,'p_side','parsereactions.py',27),
  ('molecules -> molecule','molecules',1,'p_molecules','parsereactions.py',32),
  ('molecules -> NUMBER molecule','molecules',2,'p_stoichiometry','parsereactions.py',36),
  ('side -> side PLUS molecules','side',3,'p_plus','parsereactions.py',40),
  ('molecule -> countedelement','molecule',1,'p_molecule','parsereactions.py',45),
  ('countedelement -> ELEMENT','countedelement',1,'p_countedelement','parsereactions.py',50),
  ('countedelement -> ELEMENT atomcount','countedelement',2,'p_ncountedelement','parsereactions.py',54),
  ('molecule -> molecule countedelement','molecule',2,'p_multi_element','parsereactions.py',58),
  ('atomcount -> SUBSCRIPT NUMBER','atomcount',2,'p_multi_atoms','parsereactions.py',63),
  ('atomcount -> SUBSCRIPT LBRACE NUMBER RBRACE','atomcount',4,'p_many_atoms','parsereactions.py',67),
]
